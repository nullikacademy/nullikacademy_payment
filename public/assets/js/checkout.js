...
(function () {
  ...
  var EYE_SVG = '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7z"/><circle cx="12" cy="12" r="3"/></svg>';
  ...
  function buildReview() {
    ...
    var html = rows.map(function (r) {
      if (r[0] === "__password__") {
        return '<div class="review-row"><span>رمز عبور</span>' +
          ...
          '<button type="button" id="reviewPwdToggle" class="icon-btn" aria-label="نمایش رمز">' + EYE_SVG + '</button></span></div>';
      }
    ...
    if (toggle) {
      toggle.addEventListener("click", function () {
        ...
        toggle.innerHTML = shown ? EYE_SVG : EYE_OFF_SVG;
      });
    }
  }
